   ...
   def remove_items(self):
       ...
       for item in user_cart:
           if to_delete == item:
               ...
               print "That item is not in your cart."    def view_cart(self):
       if len(user_cart) == 0:
...
def make_list():
   ...
   print "Add an items to your list, type 'list' to exit: "
   while True:
       new_list_item = raw_input("> ").lower()        if new_list_item == "list":
           show_shopping_list()        shopping_list.append(new_list_item)        if len(shopping_list) == 1:
           print "There is 1 item in your cart"
       else:
           print "There are {} items in your cart".format(len(shopping_list))
       continue def show_shopping_list():
...
def menu():
   ...
   if choice == "check out":
       ...
       Shopping_cart().add_item()# initialization
